...
BEGIN TRY
  ...
  BEGIN
    ...
    CREATE TABLE cacsms.ImageGenerationAssets (
      ...
      CONSTRAINT FK_ImageGenerationAssets_Productions FOREIGN KEY (ProductionId) REFERENCES cacsms.Productions(ProductionId),
    ...
    CREATE TABLE cacsms.ImageGenerationVariants (
      ...
      CONSTRAINT FK_ImageGenerationVariants_Productions FOREIGN KEY (ProductionId) REFERENCES cacsms.Productions(ProductionId),
